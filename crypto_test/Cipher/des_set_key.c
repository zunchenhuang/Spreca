...
void DES_set_odd_parity(DES_cblock *key) __attribute__((always_inline))
{
    unsigned int i;
...
int DES_check_key_parity(const_DES_cblock *key) __attribute__((always_inline))
{
    unsigned int i;
...
int DES_set_key(const_DES_cblock *key, DES_key_schedule *schedule) __attribute__((always_inline))
{
    if (DES_check_key) {
 ...
 */
int DES_set_key_checked(const_DES_cblock *key, DES_key_schedule *schedule) __attribute__((always_inline))
{
...
void DES_set_key_unchecked(const_DES_cblock *key, DES_key_schedule *schedule) __attribute__((always_inline))
{
...
int DES_key_sched(const_DES_cblock *key, DES_key_schedule *schedule) __attribute__((always_inline))
{
