...
static ossl_inline void blake2b_set_lastblock(BLAKE2B_CTX *S) __attribute__((always_inline))
{ 
    S->f[0] = -1;
}

/* Initialize the hashing state. */
static ossl_inline void blake2b_init0(BLAKE2B_CTX *S) __attribute__((always_inline))
{
    int i;
...
static void blake2b_init_param(BLAKE2B_CTX *S, const BLAKE2B_PARAM *P) __attribute__((always_inline))
{
    size_t i;
...
int BLAKE2b_Init(BLAKE2B_CTX *c) __attribute__((always_inline))
{
    BLAKE2B_PARAM P[1];
...
static void blake2b_compress(BLAKE2B_CTX *S __attribute__((annotate("mark"))),
                            const uint8_t *blocks,
                            size_t len) __attribute__((always_inline))
{
    uint64_t m[16];
    uint64_t v[16];
    int i;
...
int BLAKE2b_Update(BLAKE2B_CTX *c  __attribute__((annotate("mark"))), const void *data, size_t datalen) __attribute__((always_inline))
{
 ...
 * Always returns 1.
 */
int BLAKE2b_Final(unsigned char *md, BLAKE2B_CTX *c  __attribute__((annotate("mark")))) __attribute__((always_inline))
{
    int i;
...
int main()
{
    unsigned char ibuf[] = "compute,blake2b!";
    ...
    BLAKE2B_CTX c;
    BLAKE2b_Init(&c);
    BLAKE2b_Update(&c, ibuf, strlen(ibuf));
    BLAKE2b_Final(hash, &c);
}
