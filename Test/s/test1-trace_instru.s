	.text
	.file	"llvm-link"
	.file	1 "/home/fase2022/artifact/Test/test1.c"
	.globl	main                    # -- Begin function main
	.p2align	4, 0x90
	.type	main,@function
main:                                   # @main
.Lfunc_begin0:
	.loc	1 5 0                   # test1.c:5:0
	.cfi_startproc
# %bb.0:
	pushq	%rbp
	...
	callq	printDDep
.Ltmp0:
	.loc	1 6 3 prologue_end      # test1.c:6:3
	movl	$2, %edi
	movl	$5, %esi
	callq	printDDep
	movl	$5, %edi
	...
	movl	$16, %esi
	callq	printDDep
	.loc	1 11 3 is_stmt 0        # test1.c:11:3
	movslq	%ebx, %r14
	movq	%r14, %rax
	shlq	$2, %rax
	leaq	A(%rip), %rbx
	addq	%rax, %rbx
	.loc	1 11 8                  # test1.c:11:8
	movl	Inst_Counter(%rip), %eax
	addl	$3, %eax
	movl	%eax, Inst_Counter(%rip)
	movl	Inst_Counter(%rip), %edi
	...
	movl	$19, %esi
	callq	printDDep
	.loc	1 13 3 is_stmt 1        # test1.c:13:3
	movl	Inst_Counter(%rip), %eax
	addl	$1, %eax
	movl	%eax, Inst_Counter(%rip)
	xorl	%eax, %eax
...
.Linfo_string1:
	.asciz	"test1.c"               # string offset=31
.Linfo_string2:
	.asciz	"/home/fase2022/artifact/Test" # string offset=39
.Linfo_string3:
	.asciz	"A"                     # string offset=68
.Linfo_string4:
	.asciz	"int"                   # string offset=70
.Linfo_string5:
	.asciz	"__ARRAY_SIZE_TYPE__"   # string offset=74
.Linfo_string6:
...
.Ldebug_info_start0:
	...
	.byte	7                       # Abbrev [7] 0x59:0x28 DW_TAG_subprogram
	.quad	.Lfunc_begin0           # DW_AT_low_pc
	.long	.Lfunc_end0-.Lfunc_begin0 # DW_AT_high_pc
