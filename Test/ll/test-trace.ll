...
define dso_local i32 @main() #0 !dbg !14 {
  ...
  call void @llvm.var.annotation(i8* %4, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 6), !dbg !19
  store i32 0, i32* %2, align 4, !dbg !20
  call void @llvm.dbg.declare(metadata i32* %3, metadata !21, metadata !DIExpression()), !dbg !22
  %5 = load i32, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @A, i64 0, i64 0), align 4, !dbg !23
  %6 = icmp eq i32 %5, 0, !dbg !24
  %7 = zext i1 %6 to i32, !dbg !24
  %8 = load i32, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @A, i64 0, i64 1), align 4, !dbg !25
  %9 = icmp eq i32 %8, 0, !dbg !26
  %10 = zext i1 %9 to i32, !dbg !26
  %11 = load i32, i32* getelementptr inbounds ([3 x i32], [3 x i32]* @A, i64 0, i64 2), align 4, !dbg !27
  %12 = icmp eq i32 %11, 0, !dbg !28
  %13 = zext i1 %12 to i32, !dbg !28
  %14 = load i32, i32* %2, align 4, !dbg !29
  %15 = sext i32 %14 to i64, !dbg !30
  %16 = getelementptr inbounds [3 x i32], [3 x i32]* @A, i64 0, i64 %15, !dbg !30
  store i32 1, i32* %16, align 4, !dbg !31
  %17 = load i32, i32* %3, align 4, !dbg !32
  %18 = icmp eq i32 %17, 1, !dbg !33
  %19 = zext i1 %18 to i32, !dbg !33
  ret i32 0, !dbg !34
}
